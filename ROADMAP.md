...
| v0.50 | Upgrades, migration, and security review | Storage format gate, rolling upgrade test, migration skeleton, disaster recovery drill, independent security review. | N -> N+1 rolling upgrade loses no epoch; incompatible format fails safely with `RS-5001`; security review issues are triaged. |
